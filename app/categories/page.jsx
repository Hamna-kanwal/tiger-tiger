...
import { getCategories } from '../action'; // Adjust path according to your folder structure

export default async function CategorySection() {
  // Server-side fetching
  const data = await getCategories();

  // Categories Main Page Schema with dynamic ItemList mapping
  const categoriesPageSchema = {
    "@context": "https://schema.org",
    "@graph": [
      {
        "@type": "CollectionPage",
        "@id": "https://www.tigertigerfoods.com/categories/#webpage",
        "url": "https://www.tigertigerfoods.com/categories/",
        "name": "Product Categories | Tiger Tiger Foods",
        "description": "Browse Tiger Tiger's pan-Asian wholesale ranges: canned, drinks, frozen, noodles and rice.",
        "isPartOf": {
        ...
        "mainEntity": {
          "@type": "ItemList",
          "itemListElement": data?.map((cat, index) => ({
            "@type": "ListItem",
            "position": index + 1,
            "name": cat.name,
            "url": `https://www.tigertigerfoods.com/categories/${cat.slug}/`
          })) || []
        }
      },
      {
  ...
  return (
    <>
      ...
      <section className="max-w-7xl mx-auto px-4 py-12 md:py-20 mt-10">
        ...
        {/* Categories Grid - UI Not Changed */}
