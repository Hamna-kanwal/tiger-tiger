...
const categories = [
  ...
  { title: 'Noodles', image: '/catrtegories_noodles.png' },      // Make sure these images exist in /public
...
export default function CategorySection() {
  ...
  <div className="mb-8 mt-8">
      ...
      {/* 9 Categories Grid (3 Columns on Desktop, 2 on Tablet, 1 on Mobile) */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {categories.map((category) => (
          <div 
            key={category.title} 
            className="group relative h-[400px] md:h-[450px] overflow-hidden rounded-[2rem] cursor-pointer shadow-lg bg-gray-100"
          >
            {/* Image Container */}
            <Image
              src={category.image}
