  ...
  return (
    <>
      <div className="sticky top-0 left-0 right-0 z-50 px-4 pointer-events-none">
        <header className="mt-4 flex items-center justify-between gap-4 md:gap-8 rounded-full bg-white/60 backdrop-blur-[24px] shadow-sm border border-white/20 px-5 py-2 md:px-6 md:py-3 max-w-7xl mx-auto pointer-events-auto will-change-transform">
          ...
          {/* Desktop Nav - CSS Group Hover Optimization */}
