    ...
    <section className="relative w-full bg-transparent flex flex-col items-center overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center text-center px-4 max-w-5xl w-full min-h-[220px] md:min-h-[200px]">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-3 mt-6 w-full px-4 sm:px-0">
          <Link href="/tt-app" prefetch={true} onMouseEnter={() => setHoverApp(true)} onMouseLeave={() => setHoverApp(false)} 
      ...
      <style jsx global>{`
        .root-hero-swiper, .root-hero-swiper * { border-radius: 0px !important; }
        .root-hero-swiper .swiper-pagination-bullet-active { background: ${brandPurple} !important; width: 24px !important; height: 8px !important; border-radius: 0px !important; }
        .root-hero-swiper .swiper-pagination-bullet { background: ${brandPurple} !important; opacity: 0.3; width: 8px !important; height: 8px !important; border-radius: 0px !important; }
        .root-hero-swiper .swiper-pagination { bottom: 20px !important; }
      `}</style>
    </section>
  );
};
