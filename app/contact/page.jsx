...
const MapSection = dynamic(() => import('../Components/MapSection'), { 
  ssr: false,
  loading: () => <div className="h-[550px] w-full bg-gray-100 animate-pulse rounded-3xl" />
});
...
const ContactSection = () => {
  ...
  const contactSchema = {
    ...
    "@graph": [
      {
        "@type": "ContactPage",
        "@id": "https://www.tigertigerfoods.com/contact/#webpage",
        "url": "https://www.tigertigerfoods.com/contact/",
        "name": "Contact | Tiger Tiger Foods",
        "description": "Contact Tiger Tiger Foods for pan-Asian wholesale supply, trade accounts and product enquiries.",
        "isPartOf": {
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 2,
            "name": "Contact",
            "item": "https://www.tigertigerfoods.com/contact/"
          }
        ]
      }
    ]
  ...
  return (
    <>
      ...
      {/* Changed pt-16 to pt-0 to move section up */}
      <section className="w-full bg-white pt-0 pb-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16 pt-10">
            ...
            <p className="max-w-3xl mx-auto text-gray-600 text-base md:text-lg">
              Ready to bring authentic Pan Asian flavours to your business? We'd love to hear from you.
            </p>
          </div>

          <div className="flex flex-col md:flex-row gap-12 lg:gap-20 items-start mb-24">
            {/* Left Side: Contact Form (Restored) */}
