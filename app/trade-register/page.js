         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="p-5 max-h-[460px] overflow-y-auto custom-scroll bg-white">
                    {cart.length === 0 ? (
                      <div className="text-center py-14 flex flex-col items-center justify-center">
                        <div className="w-16 h-16 rounded-full bg-gray-50 flex items-center justify-center text-gray-300 text-2xl mb-3 border border-dashed border-gray-200">🛒</div>
            ...
            <div className="mt-8">
              <button 
                type="submit" 
                disabled={loading}
                className="w-full bg-[#FFEB57] hover:bg-[#ebd54b] text-gray-950 font-extrabold uppercase tracking-wider py-4 px-6 rounded-xl transition duration-200 active:scale-[0.99] disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_4px_20px_rgba(255,235,87,0.25)] text-sm"
              >
                {loading ? (
